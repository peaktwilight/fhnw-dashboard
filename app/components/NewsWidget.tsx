  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    {[...Array(6)].map((_, index) => (
      <motion.div
        ...
        className="relative overflow-hidden bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-600 p-4"
      >
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            <motion.div
              ...
              initial="initial"
              animate="animate"
              className="h-5 w-24 rounded bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 dark:from-slate-700 dark:via-slate-600 dark:to-slate-700"
            />
            <motion.div 
              variants={shimmerAnimation}
              initial="initial"
          ...
          <motion.div 
            ...
            initial="initial"
            animate="animate"
            className="h-6 w-3/4 rounded bg-gradient-to-r from-slate-200 via-slate-100 to-slate-200 dark:from-slate-700 dark:via-slate-600 dark:to-slate-700"
          />
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-slate-200 dark:border-slate-600 rounded-lg bg-slate-50 dark:bg-slate-700/50 text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent"
            />
          </div>
        </div>
        {isLoading ? (
                ...
                {currentNews.map((item) => (
                  ...
                  >
                    ...
                    <a
                      ...
                      className="block h-full bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700/50 rounded-lg transition-all duration-200 p-4 border border-slate-200 dark:border-slate-600 hover:border-blue-200 dark:hover:border-blue-500/30 relative z-10 flex flex-col"
                    >
                      ...
                      <div className="flex flex-col gap-2 flex-grow">
                        ...
                        <h2 className="text-slate-900 dark:text-white font-semibold group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors duration-200 line-clamp-2 text-base leading-snug">
                          {item.title}
                        </h2>
            ...
            {totalPages > 1 && (
              ...
              >
                <motion.button
                  ...
                  className="p-2 rounded-lg text-slate-500 hover:text-blue-500 dark:text-slate-400 dark:hover:text-blue-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 hover:bg-slate-100 dark:hover:bg-slate-700"
